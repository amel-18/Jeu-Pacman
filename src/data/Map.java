...
public class Map {
  ...
  *******************************************************************/
   ...
   * @post pacmanX > 0
   * @post pacmanY > 0
   * @post couleurMur == "green" || couleurMur == "marron"
   */
  private void createMap(){
          ...
          for (String str : param) {
            ...
            switch (str) {
              case "#" :
                ...
                break;
              case "." :
                this.theMap.setFigure(i,j,new Gomme(this.tailleCase, tmpx, tmpy, false,false,false));
                this.nbrGomme += 1;
                break;
              case "*" :
                this.theMap.setFigure(i,j,new Gomme(this.tailleCase, tmpx, tmpy, true,false,false));
                this.nbrGomme += 1;
                break;
              case "@" :
                this.theMap.setFigure(i,j,new Gomme(this.tailleCase, tmpx, tmpy,false,false,true));
                this.nbrGomme += 1;
                break;
                case "-" :
                this.theMap.setFigure(i,j,new Gomme(this.tailleCase,tmpx, tmpy, false,true,false));
                this.nbrGomme += 1;
                break;
              case "P" :
    ...
    assert couleurMur == "green" || couleurMur == "pink" : "Post condition non respectée : Mauvaise couleur de mur";
